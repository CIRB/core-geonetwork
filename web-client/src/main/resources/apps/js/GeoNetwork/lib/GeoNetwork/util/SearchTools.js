...
//            filters.push(name + "=" + (encodeURIComponent(value)+""));
            filters.push(name + "=" + ((value!=null && name=='any')?this.normalize(value + "").toLowerCase():(encodeURIComponent(value)+"")));
//            filters.push(name + "=" + (value!=null?value:""));
    ...
    normalize: function (str) {
        var i = this.specialChars.length;
        while (i--) str = str.replace(this.specialChars[i], this.normalChars[i]);
        return str;
    },
