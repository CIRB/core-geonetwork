...
GeoNetwork.map.BACKGROUND_LAYERS=[new OpenLayers.Layer.WMS("Background layer","https://geoservices-urbis.irisnet.be/geoserver/wms",{layers:"urbisFR",format:"image/jpeg"},{isBaseLayer:true})];
