...
public class Dbms {
	...
	public void connect(String username, String password) throws SQLException {
		...
		if (Log.isDebugEnabled(Log.RESOURCES)) {
			Log.debug(
					Log.RESOURCES,
					"Connections after open connection with hashcode : "
							+ conn.hashCode() + ": "
	...
	public void disconnect() {
		...
		if (Log.isDebugEnabled(Log.RESOURCES)) {
			Log.debug(
					Log.RESOURCES,
					"Connections after close connection with hashcode : "
							+ hashCode + ": "
							+ +((BasicDataSource) dataSource).getNumIdle()
							+ " idle, "
							+ ((BasicDataSource) dataSource).getNumActive()
	...
	public Connection getConnection() {
		if (Log.isDebugEnabled(Log.RESOURCES)) {
			Log.debug(Log.RESOURCES,
					"Get existing connection: " + conn.hashCode());
		}
		return conn;
	}
