...
<xsl:stylesheet xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:gml="http://www.opengis.net/gml" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:geonet="http://www.fao.org/geonetwork" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:geobru="http://geobru.irisnet.be" version="1.0">
	...
	<xsl:template match="//gmd:DQ_DataQuality[gmd:scope/gmd:DQ_Scope/gmd:level/gmd:MD_ScopeCode/@codeListValue='dataset'     or gmd:scope/gmd:DQ_Scope/gmd:level/gmd:MD_ScopeCode/@codeListValue='series']" priority="1000" mode="M13">
		...
		<xsl:variable name="emptyStatement" select="     count(*/geobru:BXL_Lineage/gmd:source) + count(*/geobru:BXL_Lineage/gmd:processStep) = 0      and not(gmd:lineage/geobru:BXL_Lineage/gmd:statement[@gco:nilReason!='missing' or not(@gco:nilReason)])      "/>
		<!--ASSERT -->
		<xsl:choose>
	...
	<!--RULE -->
	<xsl:template match="//geobru:BXL_Lineage" priority="1000" mode="M14">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//geobru:BXL_Lineage"/>
	...
	<!--RULE -->
	<xsl:template match="//geobru:BXL_Distribution" priority="1000" mode="M18">
	...
	<!--RULE -->
	<xsl:template match="//gmd:MD_Metadata|//*[@gco:isoType='gmd:MD_Metadata']" priority="1000" mode="M23">
	...
	<!--RULE -->
	<xsl:template match="//gmd:MD_Metadata/gmd:hierarchyLevel|//*[@gco:isoType='gmd:MD_Metadata']/gmd:hierarchyLevel" priority="1000" mode="M29">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//gmd:MD_Metadata/gmd:hierarchyLevel|//*[@gco:isoType='gmd:MD_Metadata']/gmd:hierarchyLevel"/>
