...
<!--				<xsl:value-of select="/root/gui/env/site/name" />
				...
				geo.brussels | <!-- TODO : set date format according to locale -->
...
<!--							<fo:external-graphic padding-right="4pt" content-width="4.6cm">-->
							<fo:external-graphic padding-right="4pt">
								<xsl:attribute name="src"> url('<xsl:value-of
									select="concat( //server/protocol, '://', //server/host,':', //server/port, /root/gui/url,'/images/logos/logo.png')" />')" </xsl:attribute>
							</fo:external-graphic>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
