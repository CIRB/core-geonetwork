...
public class InspireAtomUtil {
	...
	public static boolean isAtomDownloadServiceMetadata(DataManager dm, /*
		...
		String serviceTypeVersion = service.getChildText("serviceTypeVersion")
				.trim();
		return "download".equalsIgnoreCase(serviceType)
				&& "INSPIRE ATOM V3.1".equalsIgnoreCase(serviceTypeVersion);
	}
	...
	public static Element getDatasetFeed(Element params, ServiceContext context)
			throws Exception {
		String datasetIdCode = Util.getParam(params,
				DATASET_IDENTIFIER_CODE_PARAM);
		String datasetIdNs = Util.getParam(params, DATASET_IDENTIFIER_NS_PARAM);
		return getDatasetFeed(datasetIdCode, datasetIdNs, context);
	}

	public static Element getDatasetFeed(String datasetIdCode,
			String datasetIdNs, ServiceContext context) throws Exception {
		...
		String fileIdentifier = InspireAtomUtil
				.getFileIdentifierByDatasetIdentifier(context, datasetIdCode);
			...
			if (o != null && o instanceof Element) {
				String codeSpaceValue = ((Element) o).getText();
				{
					if (!StringUtils.isBlank(codeSpaceValue)
						...
						try {
							return datasetEl.addContent(InspireAtomUtil
	...
	public static Element getServiceFeed(String fileIdentifier,
		...
		Element datasetsEl = processDatasetsInfo(dm, dbms,
				datasetFileIdentifiers, fileIdentifier, context, webappName);
	...
	private static Element processDatasetsInfo(DataManager dm, Dbms dbms,
			final List<String> datasetFileIdentifiers,
